...
if __name__ == "__main__":
    ...
    if choice == "1":
        run_simulator(cycles=None, min_orders_per_cycle=0, max_orders_per_cycle=3, sleep_seconds=10)
    elif choice == "2":
        try:
            ...
            if cycles <= 0:
                ...
                sys.exit(1)
            run_simulator(cycles=cycles, min_orders_per_cycle=0, max_orders_per_cycle=3, sleep_seconds= 10)
        except ValueError:
